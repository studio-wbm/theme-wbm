...
function spintheme_scripts() {
    ...
    wp_enqueue_style('style-min', get_template_directory_uri() . '/build/css/main.min.css');
    ...
    wp_enqueue_script('functions', get_template_directory_uri() . '/build/js/functions.min.js', null, null, true);
}
